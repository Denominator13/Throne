...
namespace Throne.World.Properties
{
    public static class Constants
    {
        ...
        {
            public static readonly WorldPacket NameInvalid = new ChatMessage(MessageChannel.Popup,
                StrRes.CMSG_CharacterNameUnavailable);
        ...
        public static class LoginMessages
        {
            ...
            public static readonly WorldPacket BadAuthentication = new ChatMessage(MessageChannel.Login,
                StrRes.CMSG_AuthenticationFailed);
